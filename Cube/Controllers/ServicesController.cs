...
namespace Cube.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        public ServicesController(CubeProjetIndiContext context)
        {
            _context = context;
        }
        [AllowAnonymous]
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var found = context.Where(x => x.ServiceId == id);

            if (found is not null)
            {
                ViewData["Delete"] = " Cant delete an user still attribued this service";
            ...
            {
                return Problem("Entity set 'CubeProjetIndiContext.Services'  is null.");
            }
            var services = await _context.Services.FindAsync(id);
            if (services != null)
            {
